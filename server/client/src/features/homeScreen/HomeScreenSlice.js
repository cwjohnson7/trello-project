...
const initialState = {
  user: { _id: "sf24d", firstName: "Yegor", lastName: "Rodin", organization: "Parsity" },
  boards: [
    {
    _id: "089sd",
    title: "Daily Planner",
...
export const homeScreenSlice = createSlice({
  ...
  reducers: {
    moveCard: (state, action) => {
      state.boards.find(board => board._id === action.payload.source)
    }
  },
...
export const { actions } = homeScreenSlice.actions;
